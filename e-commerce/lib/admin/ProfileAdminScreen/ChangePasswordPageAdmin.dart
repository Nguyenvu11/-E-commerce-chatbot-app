...
class ChangePasswordPageAdmin extends StatefulWidget {

  @override
  _ChangePasswordStateAdmin createState() => _ChangePasswordStateAdmin();
}


class _ChangePasswordStateAdmin extends State<ChangePasswordPageAdmin> {
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      String textValueNew = confirmpasswordTextEdittingController
                          .text;
                      if (textValue != andminInformation!.password.toString() ||
  ...
  void UpdatePassword() {
    ...
    if (newPassword == confirmPassword) {
      DatabaseReference adminsRef = FirebaseDatabase.instance.ref().child("admins").child(currentfirebaseAdmin!.uid);
      adminsRef.update({
