...
import 'package:coffee_house/admin/AllAdminWidgets/progressAdminDialog.dart';
...
class _RegisterScreenState extends State<RegisterAdminScreen> {
  ...
  Future<void> registerNewUser(BuildContext context) async {
    ...
    if (firebaseUser != null) {
      ...
      adminsRef.child(firebaseUser.uid);
      Map userDateMap = {
      ...
      adminsRef.child(firebaseUser.uid).set(userDateMap).then((_) {
